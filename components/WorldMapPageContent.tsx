...
export function WorldMapPageContent() {
    ...
    <div className="space-y-5 sm:space-y-6">
      <header>
        ...
        <p className="mt-1 max-w-2xl text-sm text-slate-600 dark:text-slate-400">
          Explore every country on an interactive world map. Pan and zoom to find a place, then click to
          select it and jump to its Library entry.
        </p>
      </header>

      <WorldMapExplorer initialPlaceCode={initialPlaceCode} />
    </div>
  );
}
