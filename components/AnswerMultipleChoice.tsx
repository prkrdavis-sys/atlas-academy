      ...
      {options.map((option, index) => {
        ...
        return (
          <button
            ...
            className={cn(
              "min-h-[3.25rem] rounded-2xl border-2 border-slate-200 bg-white px-2 py-3 text-center text-[13px] font-semibold leading-tight text-slate-700 sm:px-4 sm:py-4 sm:text-left sm:text-sm",
              "shadow-[0_3px_0_var(--color-slate-200)] transition-all duration-100",
