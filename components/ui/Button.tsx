  ...
  return (
    <button
      className={cn(
        ...
        variant === "secondary" &&
          "border-2 border-slate-200 bg-white text-slate-700 shadow-[0_3px_0_var(--color-slate-200)] hover:border-sky-300 hover:text-sky-700 disabled:shadow-[0_3px_0_var(--color-slate-200)]",
        variant === "ghost" && "bg-transparent text-slate-600 hover:bg-slate-900/5",
        variant === "danger" &&
