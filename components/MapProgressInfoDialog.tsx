    ...
    <div className="fixed inset-0 z-[80] grid place-items-center p-4 sm:p-6">
      ...
      >
        ...
        >
          ...
          <strong className="font-semibold text-slate-800 dark:text-slate-100">Trivia</strong> — to fully
          complete a {placeNoun}. Mixed, Daily Challenge, Marathon, and Speed Round count when the question
          matches a category. Full mastery shines gold on Normal and a legendary rainbow shimmer on Hard.
        </p>
