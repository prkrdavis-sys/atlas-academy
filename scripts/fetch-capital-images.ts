...
const COMMONS_FILE_OVERRIDES: Record<string, string> = {
  ...
  BO: "Sucre capital of Bolivia.JPG",
  ...
  JM: "Kingston, Jamaica.JPG",
  KY: "Camana Bay skyline.jpg",
  MF: "Marigot, Saint Martin (15648526873).jpg",
  ...
  MD: "Chisinau dendrarium - skyline and grass field.jpg",
  MP: "Saipan.jpg",
  ...
  SK: "Bratislava skyline 1.jpg",
  SO: "Mogadishu, Somalia.JPG",
