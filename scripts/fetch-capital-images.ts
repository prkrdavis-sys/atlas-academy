...
const COMMONS_FILE_OVERRIDES: Record<string, string> = {
  ...
  KM: "Moroni City Comoros.JPG",
  NU: "Alofi before sunset.jpg",
  TV: "Tuvalu Funafuti Atoll from the Airplane.jpg",
  TC: "Cockburn Town, Grand Turk.jpg",
  US: "Washington DC Panorama.jpg",
  "US-WV": "Charleston, West Virginia (2023).jpg",
  "US-DE": "Dover Delaware.jpg",
  "US-MT": "1883 bird's eye view of Helena, Montana. The capitol of Montana and county seat of Lewis and Clarke Co. LOC 75694670.jpg",
  "US-VT": "Montpelier with state capitol in distance.jpg",
  "US-WY": "CheyennePanorama.jpg",
  "US-FL": "TallahasseeSkyline2.JPG",
  "US-ID": "Boise Idaho aerial view.jpg",
  "US-NV": "Skyline of Carson City, NV.jpg",
  "US-SD": "South Dakota - Pierre - NARA - 68148932 (cropped).jpg",
  "US-NH": "Aerial view of state and city buildings, Concord, N.H (75918).jpg",
  EH: "Aerial photograph of Laayoune 04.jpg",
  ZW: "Harare skyline.jpg",
  "US-OR": "Salem Oregon aerial.jpg",
  AW: "BNA-DIG-MEINERS-0154 - Luchtfoto's 27 - 640900 - Oranjestad c.jpg",
  BO: "Panorama, Sucre, Bolivia.jpg",
  BR: "Brasília Panorama.jpg",
  BS: "Nassau, Bahamas aerial view.jpg",
  CW: "Curacao Willemstad Pano (36653932906).jpg",
  DM: "View of Roseau (4).jpg",
  DO: "View of Santo Domingo Skyline.jpg",
  EC: "Vista de Quito desde El Panecillo, Ecuador, 2015-07-22, DD 25-29 PAN.JPG",
  GP: "Vue du centre de Basse-Terre, Guadeloupe.jpg",
  HN: "Tegucigalpa-skyline-2024.jpg",
  HT: "Port-Au-Prince, Haiti from the Black Mountains.jpg",
  JM: "PortofKingston.jpg",
  KN: "Basseterre.jpeg",
  KY: "George Town Harbour.jpg",
  MF: "Marigot St Martin.jpg",
  MQ: "Martinique - Fort-de-France Centre-Ville.jpg",
  MS: "Little Bay from above, Montserrat.JPG",
  NI: "Managua skyline.jpg",
  PM: "Sainte-Pierre aerial.jpg",
  PR: "The Skyline of San Juan with the Capitol of Puerto Rico.jpg",
  PY: "Asunción skyline from Chaco'i.jpg",
  SX: "Philipsburg, St. Maarten, Netherlands Antilles (32741901691).jpg",
  TT: "Port of Spain night skyline 2008.jpg",
  UY: "Montevideo skyline (282952662).jpg",
  VE: "Caracas skyline and Avila mountain from my penthouse.JPG",
  VI: "U.S. Virgin Islands - View of Charlotte Amalie from cruise terminal.jpg",
  AL: "Tirana panorama (7246584338).jpg",
  BE: "Brussels skyline 1003.JPG",
  BF: "Ouagadougou-Vue aérienne nocturne (1).jpg",
  BG: "Sofia skyline.jpg",
  BI: "Gitega.JPG",
  BT: "Thimphu panorama 01.jpg",
  BY: "MinskCityPanorama.jpg",
  CD: "La Gombe, Kinshasa, RDC.jpg",
  CG: "Vue aérienne de Brazzaville 13.jpg",
  CX: "Flying Fish Cove.jpg",
  CY: "Nicosia panoramic view Cyprus Tower 25 Jean Nouvel.jpg",
  CZ: "Prague skyline panorama 2 (7155167583).jpg",
  DJ: "An aerial view of Djibouti City.jpg",
  DK: "Skyline, Copenhagen, 2023.jpg",
  FO: "Tórshavn Panorama.jpg",
  FR: "Paris Panorama.jpg",
  GE: "Panorama of Tbilisi.jpg",
  GG: "Guernsey, St. Peter's Port, general view of harbor, Channel Islands-LCCN2002696477.jpg",
  GN: "Conakry.jpg",
  GR: "View of Athens from Lycabettus.jpg",
  HR: "Vista de Zagreb, Croacia, 2014-04-13, DD 01.JPG",
  IT: "Roma dall'alto.jpg",
  KG: "Bishkek City's business center.jpg",
  LI: "Vista de Vaduz, Liechtenstein, 2022-10-23, DD 28.jpg",
  MD: "Chisinau, Republic of Moldova.jpg",
  ME: "Podgorica panorama.jpg",
  MP: "Saipan.jpg",
  ML: "Bamako ACI 2000 Aeriel.jpg",
  MT: "Valletta skyline.jpg",
  NA: "Windhoek-Skyline.jpg",
  NC: "NouméaCentre.jpg",
  NL: "Amsterdam A'DAM Tower Blick vom Turm auf den IJ 03.jpg",
  NO: "Oslo panorama.jpg",
  PK: "Islamabad skyline.jpg",
  PT: "LisbonSkyline.jpg",
  RS: "Serbia, Novi Beograd, panorama, 06 May 2012.jpg",
  SB: "Aerial view of Honiara, 2013.jpg",
  SE: "Stockholm aerial 5.jpg",
  SJ: "Longyearbyen, Svalbard - aerial view.jpg",
  SK: "Bratislava (Pressburg, Pozsony) - panorama.jpg",
  SO: "Aerialmog2.jpg",
  TL: "DSCI3101 Blick runter auf Dili.JPG",
  UA: "Kyiv skyline (15688086793).jpg",
  VA: "Panorama Vatican, St. Peter's Basilica and Gardens of Vatican City (46800435851).jpg",
  ZA: "Pretoria, uitsig oor middestad.jpg",
  IQ: "View on Baghdad 2017.jpg",
  LR: "An aerial view of the West Point area of Monrovia.jpg",
  VN: "Hanoi Skyline panorama.JPG",
  MO: "Panorama of Macau Peninsula2021.jpg",
  SA: "Riyadh Skyline showing the King Abdullah Financial District (KAFD) and the famous Kingdom Tower .jpg",
  TR: "Havadan Ankara 01.jpg",
  BJ: "Iss072e069105 (Oct 15, 2024) --- Porto-Novo, the capital of Benin with a population of over 260,000, is situated on the Yewa River next to the coast of the Gulf of Guinea in this photograph from the International Spac.jpg",
  MM: "Ministry Zone, Naypyitaw, Myanmar (Burma) - panoramio.jpg",
  GA: "Libreville, Baie des Rois.jpg",
  IO: "Diego Garcia (satellite).jpg",
  // Africa capital skyline/aerial downtown redo (2026-07-27 visual audit)
  BW: "Gaborone skyline.JPG",
  CM: "Vue aérienne de Yaoundé en avril 1974.jpg",
  ...
  MG: "Panorama of Antananarivo (3953594664).jpg",
  MR: "Nouakchott air 01.jpg",
  MU: "PortLouis.JPG",
  YT: "Mamoudzou (10029936275).jpg",
  MA: "Rabat maroc Panorama (14870472795).jpg",
  NE: "Niamey from grand mosque theatre 2006.jpg",
  NG: "Twin Towers, Central Business District, Abuja.jpeg",
  RE: "Centre-ville-de-Saint-Denis.JPG",
  SC: "Seychelles-Mahé-victoria-kevin-gepford.jpg",
  SL: "Freetown-aerialview.jpg",
  SS: "Juba City.jpg",
  TN: "Skyline of Tunis.jpg",
  UG: "Kampala skyline.jpg",
  // Oceania / Antarctica remaining-slice skyline audit replacements
  AU: "Canberra From Black Mountain Tower.jpg",
  NZ: "Wellington Skyline (34319401232).jpg",
  GS: "King Edward Point (South Georgia).jpg",
  FJ: "Suva City 2 February 2015.jpg",
  PG: "Aerial view of Port Moresby.jpg",
  AS: "Pagopago amerika sāmoa.jpg",
  GU: "Hagatna from Fort Santa Agueda.JPG",
  WS: "Apia, Samoa.JPG",
  MH: "11.01 馬紹爾共和國馬久羅島鳥瞰 (38041559416).jpg",
  CK: "Rarotonga Island.jpg",
  NF: "Kingston from Flagstaff Hill.jpg",
  FM: "Palikir Government Buildings.jpg",
  ...
  KW: "Kuwait City Skyline 1.jpg",
  SY: "Damascus Panorama.jpg",
  KP: "Pyongyang (vista panorámica) 00001.JPG",
  PS: "PS-Ramallah view.JPG",
  LB: "Beirut From Airplane (5578982458).jpg",
